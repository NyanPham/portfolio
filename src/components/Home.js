        ...
        <section id="home" ref={homeRef} className={isVisible ? "visible" : ""}>
            ...
            <div className="home-right">
                <div className="greeting">
                    <h2>
                        Hy, I'm <span className="my-name">Nyan</span>
                    </h2>
                    <p className="position">Frontend Developer</p>
                    <p className="greeting-text">
                        I'm a junior web developer specializing in building new digital experience. Currently, I'm in a
                        team focused on building eCommerce-centered templates on Shopify platform.
                    </p>
                    <div className="contact-and-social">
                        ...
                        <div className="social-links">
                            ...
                            <a
                                href="https://www.linkedin.com/in/nhan-pham-84a602232/"
                                className="fa"
                                target="_blank"
                                rel="noreferrer"
                            >

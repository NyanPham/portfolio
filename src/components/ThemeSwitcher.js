...
const ThemeSwitcher = ({ handleThemeChange, darkTheme }) => {
    const switchOnAudio = new Audio(switchOnSound)
    const switchOffAudio = new Audio(switchOffSound)

    function toggleTheme() {
        if (!darkTheme) switchOnAudio.play()
        else switchOffAudio.play()

        ...
        <section id="about">
            ...
            <div className="my-intro">
                <div className="my-text">
                    <p>
                        Hello! My name is Nhàn and I enjoy creating things with own hands, experience and skills. I am
                        an ex-interpreter and tour guide because of my passion in languages. My interest in web
                        development started back in 2021 after 2 years learning programming with Python. The more I
                        dived into the web structure, the more I fall in love with JavaScript. And as a language lover,
                        it hooked me (Though I know human languages and programming languages are not so the same).
                    </p>
                    <p>
                        Nowadays, I've had 1 year of Front-End experience working with vanila JavaScript to build
                        inclusive, customizable eCommerce templates on Shopify. With the desire to learn more about
                        technology, I decided to launch my own project that resembles a fully functional eCommerce site,
                ...
                <div className="illustration-container">
                    <div className="illustration">
                        <svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" viewBox="0 0 711.1879 669.68268">
                            <title>feeling_proud</title>
                            <polygon points="516.326 380.018 516.326 565.013 547.27 615.443 549.625 619.279 671.722 619.279 674.189 380.018 516.326 380.018" />
                            <polygon
                                points="516.326 380.018 516.326 565.013 547.27 615.443 549.169 380.018 516.326 380.018"
                                opacity="0.1"
                            />
                            <polygon points="221.566 375.084 221.566 560.08 190.622 610.51 188.267 614.345 66.17 614.345 63.703 375.084 221.566 375.084" />
                            <polygon
                                points="221.566 375.084 221.566 560.08 190.622 610.51 188.723 375.084 221.566 375.084"
                                opacity="0.1"
                            />
                            <polygon points="711.188 371.385 711.188 382.484 47.67 382.484 47.67 366.451 109.335 334.385 656.923 334.385 711.188 371.385" />
                            <polygon
